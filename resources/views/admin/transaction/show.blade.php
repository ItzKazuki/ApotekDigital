    ...
    <div class="max-w-5xl mx-auto space-y-8">
        ...
        <div class="bg-white shadow rounded-lg p-6 space-y-2">
            ...
            @if (config('app.tax.enabled'))
                <div class="flex justify-between">
                    ...
                    <span>Rp{{ number_format(config('app.tax.value'), 0, ',', '.') }}</span>
                </div>
            @endif
            <div class="flex justify-between">
                <span>Kembalian</span>
        ...
        <div class="flex justify-between">
            ...
            @if ($transaction->status !== \App\Models\Transaction::STATUS_PAID)
                <a href="{{ route('admin.transaction.updatePaymentStatus', ['transaction' => $transaction->id, 'status' => \App\Models\Transaction::STATUS_PAID]) }}"

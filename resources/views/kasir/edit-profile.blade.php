...
@section('content')
    ...
    <form action="{{ route('kasir.profile.update') }}" class="bg-white rounded-lg shadow p-6 space-y-6"
        enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')
        <div class="flex flex-col md:flex-row md:items-center md:space-x-6">
            <div class="flex-shrink-0 mb-4 md:mb-0">
                <img alt="User profile photo, round with yellow background and initials CI"
            ...
            <div>
                ...
                <input accept="image/*"
                    class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-yellow-600 file:text-white hover:file:bg-yellow-700 cursor-pointer"
        ...
        <div>
            ...
            <input
                class="w-full border border-gray-300 rounded px-3 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-600"
